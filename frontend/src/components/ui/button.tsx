  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        whatsapp:
          "bg-whatsapp text-whatsapp-foreground shadow-md hover:bg-whatsapp/90 hover:shadow-lg active:scale-[0.98]",
        call:
          "bg-call text-call-foreground shadow-md hover:bg-call/90 hover:shadow-lg active:scale-[0.98]",
        hero:
        ...
        cta:
          "bg-gradient-cta text-whatsapp-foreground shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]",
      },
      size: {
